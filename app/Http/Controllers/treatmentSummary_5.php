...
class treatmentSummary_5 extends Controller
{
    public function treatmentSummary_5()
    {   
        ...
        $pdf = Pdf::loadView('report.treatmentSummary_5', $data , compact('safeguardOptions'));
        $pdf->set_paper('A4', 'landscape');

        // Stream the generated PDF to the browser
        $currentDate = date('Y-m-d');
        return $pdf->stream('treatment-summary-scale5-' . $currentDate . '.pdf');
    }
}
