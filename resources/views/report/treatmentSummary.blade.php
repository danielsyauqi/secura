...
<html>
<head>
    <title>Risk Treatment Plan Summary Report</title>
    <style>
            ...
            @php
                ...
                <tr>
                    ...
                    @endphp
                        ...
                        <td>{{ $riskLevel->Low + $riskLevel->Medium + $riskLevel->High }} / {{ $assetCount }}</td>
                ...
                <tr style="background-color:#ffff97; font-weight: bold;">
                    <td>Total</td>
                    <td>{{ $riskLevels->sum(function($riskLevel) { return $riskLevel->Low + $riskLevel->Medium + $riskLevel->High; }) }}</td>
