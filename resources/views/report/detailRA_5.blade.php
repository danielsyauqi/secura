                                ...
                                @foreach ($assetsByType as $index => $asset)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @foreach ($asset->threats as $threat)
                                                    ...
                                                    @endphp
                                                    <!-- Business Loss -->
                                                    <div>{{ $rmsd->business_loss_5 ?? 'N/A' }}</div>
                                                    <br>
                                                    @endforeach
                                            </td>
                                            ...
                                            <td>
                                                @foreach ($asset->threats as $threat)
                                                    ...
                                                    @endphp
                                                    <!-- Impact Level -->
                                                    <div>{{ $rmsd->impact_level_5 ?? 'N/A' }}</div>
                                                    <br>
                                                    @endforeach
                                            </td>
                                    ...
                                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $asset->valuation->business_loss_5 ?? 'N/A' }}</td>
                                            <td>{{ $asset->valuation->impact_level_5 ?? 'N/A' }}</td>
                                            <td>{{ $asset->valuation->likelihood_5 ?? 'N/A' }}</td>
                                            <td>{{ $asset->valuation->risk_level_5 ?? 'N/A' }}</td>
                                        </tr>
                                    @endif
                                @endforeach
