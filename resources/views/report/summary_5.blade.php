    ...
    <div style="page-break-after: always;">
        ...
        <table>
            ...
            <tbody>
                ...
                $assets = DB::table('asset_management')
                    ...
                    ->whereIn('asset_management.type', [
                        'Hardware', 'Software', 'Data and Information', 'Human Resources', 'Services', 'Work Process', 'Premise'
                    ]) // Fetch only these types
            ...
            @endphp
                ...
                <tr class="total">
                    <td>Total</td>
                    <td>{{ $assets->sum('VeryLow') }}</td>
                    <td>{{ $assets->sum('Low') }}</td>
                    <td>{{ $assets->sum('Medium')  }}</td>
                    <td>{{ $assets->sum('High') }}</td>
                    <td>{{ $assets->sum('VeryHigh') }}</td>
                    <td>{{ $assets->sum('VeryLow') + $assets->sum('Low') +  $assets->sum('Medium') + $assets->sum('High') + $assets->sum('VeryHigh')}}  / {{ $assets->sum('count')  }}</td>
                </tr>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th colspan="5">Impact Level</th>
                </tr>
                <tr>
                    <th style="width: 10%;">Very Low</th>
                    <th style="width: 10%;">Low</th>
                    <th style="width: 10%;">Medium</th>
                    <th style="width: 10%;">High</th>
                    <th style="width: 10%;">Very High</th>
